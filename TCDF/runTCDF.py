...
def plotgraph(stringdatafile,alldelays,columns):
    ...
    nx.draw(G,pos, node_color = 'white', edge_color='black',node_size=100,font_size=10,with_labels = True)
    ax = plt.gca()
    ax.collections[0].set_edgecolor("#000000") 

    #plt.show()
    plt.savefig('trials2.png')
